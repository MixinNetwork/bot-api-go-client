...
func TestMixinInvoice(t *testing.T) {
	...
	require.Len(e1.externalReferences, 1)
	require.Equal(ref1, e1.externalReferences[0])
	...
	require.Len(e2.externalReferences, 1)
	require.Equal(ref2, e2.externalReferences[0])
}
